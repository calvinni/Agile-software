...
<!-- home slider -->
   <!-- <section class="home-slider">
    <p>a slider display recycle articles</p>
    <button type="button">a button click to read more</button>
   </section> -->
   <div id="carouselControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./images/10181.jpg" height="600" width="100%" alt="1" >
            </div>
            <div class="carousel-item">
                <img src="./images/Garbage recycle bins set.jpg" height="600" width="100%" alt="2">
            </div>
            <div class="carousel-item">
                <img src="./images/Garbage sorting set.jpg" height="600" width="100%" alt="3">
            </div>
        </div>
   </div>
...
<div id="catcarouselCaptions" class="carousel slide" data-bs-ride="false">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./images/utilization-empty-water-bottle.jpg" height="600" width="100%" alt="plastic bottle">
    ...
    <div class="carousel-item">
      <img src="./images/recycling-concept-flat-lay.jpg" height="600" width="100%" alt="paper">
      <div class="carousel-caption d-none d-md-block">
        <h5>What we collect</h5>
        <p>Recycle papers</p>
      </div>
